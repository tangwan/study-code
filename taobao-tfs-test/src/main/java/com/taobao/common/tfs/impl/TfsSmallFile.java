...
public class TfsSmallFile extends TfsFile {
     ...
     * @exception
     */
    public int unlinkUnique(UniqueStore uniqueStore) throws TfsException {
        FileInfo info = stat();
    ...
    public int unlinkUnique(UniqueStore uniqueStore, String mainName, String suffix) throws TfsException {
        open(mainName, suffix, TfsConstant.READ_MODE);
        return unlinkUnique(uniqueStore);
    }

    public int unlinkUnique(UniqueStore uniqueStore, String tfsName) throws TfsException {
